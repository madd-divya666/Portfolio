  ...
  experience: [
    {
      ...
      company: "Gamux",
      duration: "June 2025 – Mar 2025",
      location: "Remote",
      details: [
        "Developed and maintained backend services using Node.js, Express.js, and MongoDB (Mongoose).",
        "Designed and implemented 25+ RESTful APIs for core application features and platform functionalities.",
        "Implemented secure authentication and role-based access control using JWT and middleware.",
        "Designed and optimized MongoDB schemas, including data validation and efficient query handling.",
        "Optimized database queries and API performance to reduce response time and improve scalability.",
        "Integrated React.js frontend with backend services to deliver seamless user experiences.",
        "Built responsive and reusable UI components using Tailwind CSS to enhance usability and performance.",
        "Integrated Gemini API to extract questions/answers from PDFs and generate MCQ options.",
        "Collaborated with cross-functional teams using GitHub for version control, code reviews, and issue tracking.",
        "Followed Agile development practices and contributed to debugging, testing, and performance improvements.",
      ],
      techUsed: [
        "React.js",
        "Node.js",
